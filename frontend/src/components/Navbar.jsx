    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm transition-all">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 ml-4 border-l pl-8 border-gray-100">
            ...
            {user ? (
              <div className="flex items-center gap-4">
                <Link
                  to="/profile"
                  className="flex items-center gap-2 text-sm font-bold text-gray-900 bg-gray-50 px-4 py-2 rounded-full hover:bg-green-50 transition-all"
                >
              ...
              <Link
                to="/login"
                className="text-sm font-bold text-green-600 hover:text-amber-600 transition-colors"
              >
                {t("login")}
              </Link>
            )}
            ...
            <Link
              to="/cart"
              className="relative p-2 bg-green-50 text-green-700 rounded-xl hover:bg-amber-100 hover:text-amber-800 transition-all group"
            >
              <LuShoppingCart
                size={22}
        ...
        <div className="flex items-center gap-3 md:hidden">
          ...
          <Link
            to="/cart"
            className="relative p-2 bg-green-50 text-green-700 rounded-xl"
          >
        ...
        <div className="md:hidden bg-white border-t border-gray-50 p-6 space-y-4 animate-in slide-in-from-top duration-300">
          ...
          <div className="pt-4 border-t border-gray-50">
            {user ? (
              ...
              <Link
                to="/login"
                className="block text-lg font-bold text-green-600"
              >
                Login
              </Link>
            )}

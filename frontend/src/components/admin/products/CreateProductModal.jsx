    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative w-full max-w-3xl bg-white dark:bg-gray-900 rounded-3xl shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-gray-800">
          <div>
            <h2 className="text-xl font-black text-gray-900 dark:text-white">Add New Product</h2>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <form id="create-product-form" onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-5">
              <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-wider">Basic Information</h3>
            ...
            {/* Pricing & Inventory */}
            <div className="space-y-5">
              <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-wider">Pricing & Inventory</h3>
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-wider">Product Images</h3>
                <span className="text-xs text-gray-500">{images.length}/5 images</span>
              </div>
              
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-4">
                {imagePreviews.map((preview, idx) => (
                  <div key={idx} className="relative aspect-square rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden group">
            ...
            {/* Settings */}
            <div className="space-y-5">
              <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-wider">Settings</h3>
              ...
              <div className="flex gap-6 mt-4">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Featured Product</span>
                </label>
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  <input 
                    ...
                    className="w-5 h-5 accent-green-600 rounded" 
                  />
                  <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Trending Product</span>
                </label>
              </div>
            </div>
        ...
        <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-end gap-3 bg-gray-50 dark:bg-gray-900/50 rounded-b-3xl">
          ...
          >
            {loading ? <LuLoaderCircle className="animate-spin" size={20} /> : "Save Product"}
          </button>
        </div>

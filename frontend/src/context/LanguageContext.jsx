...
export const translations = {
  en: {
    ...
    hero_subtitle:
      "Modern tools for modern farmers. Get the best deals on tractors, seeds, and irrigation systems.",
    ...
    about_desc:
      "A trusted name in agriculture equipment, located in Kargoon District, Bamandi. We are committed to providing quality products and excellent service to our farmers.",
    ...
    address_detail_hint:
      "Please be detailed. Our logistics partners require accurate addressing.",
    return_to_cart: "Return to Cart",
    continue_summary: "Continue to Summary",
    order_summary: "Order Summary",
    review_summary:
      "Please review your selections and destination before confirming payment.",
    ...
    shipping_sec_2_desc:
      "Standard delivery typically takes 3-5 business days. Delivery delays can occasionally occur.",
    returns_sec_1: "Returns Eligibility",
    returns_sec_1_desc:
      "Items must be unused and in the same condition that you received them. You have 7 days to return an item.",
    bulk_desc:
      "Interested in ordering large quantities for your farm or business? Contact us for special pricing.",
    contact_desc:
      "Have questions about our products? Reach out to our team in Kargoon, MP.",
  ...
  hi: {
    ...
    hero_subtitle:
      "आधुनिक किसानों के लिए आधुनिक उपकरण। ट्रैक्टर, बीज और सिंचाई प्रणालियों पर सर्वोत्तम सौदे प्राप्त करें।",
    hero_main_title: "प्रत्येक किसान के लिए विश्वसनीय कृषि उपकरण",
    hero_main_subtitle:
      "किफायती कीमतों पर सर्वोत्तम गुणवत्ता वाले सिंचाई किट, उपकरण और ट्रेलर।",
    shop_now: "अभी खरीदें",
    ...
    trusted_seller_desc:
      "खरगोन और आसपास के क्षेत्रों में किसानों की सेवा कर रहे हैं।",
    ...
    affordable_prices_desc:
      "सर्वोत्तम कीमतों पर सर्वोत्तम गुणवत्ता वाले उत्पाद।",
    ...
    about_desc:
      "खरगोन जिले, बामंदी में स्थित कृषि उपकरणों में एक विश्वसनीय नाम। हम अपने किसानों को गुणवत्तापूर्ण उत्पाद और उत्कृष्ट सेवा प्रदान करने के लिए प्रतिबद्ध हैं।",
    ...
    cart_empty_desc:
      "ऐसा लगता है कि आपने अभी तक कुछ भी नहीं जोड़ा है। शुरू करने के लिए हमारे प्रीमियम उपकरणों को देखें।",
    ...
    // Footer
    footer_about:
      "प्रीमियम कृषि आपूर्ति, पारंपरिक सामान और सीधे प्रामाणिक खेतों और कारीगरों से प्राप्त शुद्ध आध्यात्मिक आवश्यक वस्तुओं के लिए आपका विश्वसनीय बाज़ार।",
    ...
    register_success:
      "खाता सफलतापूर्वक बनाया गया! लॉगिन पर रीडायरेक्ट कर रहा है...",
    ...
    address_detail_hint:
      "कृपया विस्तार से बताएं। हमारे लॉजिस्टिक्स भागीदारों को सटीक पते की आवश्यकता होती है।",
    return_to_cart: "कार्ट पर वापस जाएं",
    continue_summary: "सारांश पर जारी रखें",
    order_summary: "ऑर्डर सारांश",
    review_summary:
      "भुगतान की पुष्टि करने से पहले कृपया अपने चयन और गंतव्य की समीक्षा करें।",
    items_overview: "आइटम ओवरव्यू",
    standard_delivery: "स्टैंडर्ड डिलीवरी",
    edit_shipping: "शिपिंग बदलें",
    place_order_btn: "ऑर्डर दें",
    order_success:
      "ऑर्डर सफलतापूर्वक दिया गया! हम पर भरोसा करने के लिए धन्यवाद।",
    ...
    shipping_sec_1_desc:
      "सभी ऑर्डर 1-2 व्यावसायिक दिनों के भीतर संसाधित किए जाते हैं। सप्ताहांत या छुट्टियों पर ऑर्डर शिप या डिलीवर नहीं किए जाते हैं।",
    shipping_sec_2: "शिपिंग दरें और अनुमान",
    shipping_sec_2_desc:
      "स्टैंडर्ड डिलीवरी में आमतौर पर 3-5 व्यावसायिक दिन लगते हैं। क्षेत्रीय बाधाओं के कारण देरी हो सकती है।",
    returns_sec_1: "वापसी की पात्रता",
    returns_sec_1_desc:
      "आइटम अप्रयुक्त और उसी स्थिति में होने चाहिए जिसमें आपने उन्हें प्राप्त किया था। आपके पास आइटम वापस करने के लिए 7 दिन हैं।",
    bulk_desc:
      "अपने खेत या व्यवसाय के लिए बड़ी मात्रा में ऑर्डर करने में रुचि रखते हैं? विशेष मूल्य निर्धारण के लिए हमसे संपर्क करें।",
    contact_desc:
      "हमारे उत्पादों के बारे में प्रश्न हैं? खरगोन, मप्र में हमारी टीम से संपर्क करें।",

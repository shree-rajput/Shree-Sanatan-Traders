        ...
        <div className="bg-white rounded-[48px] shadow-2xl border-4 border-white p-10 md:p-16">
          ...
          <div className="space-y-12">
            ...
            <section className="p-8 border-2 border-green-50 rounded-[32px] bg-white">
              ...
              <p className="text-gray-500 font-bold leading-relaxed">
                Opened seed packets, used irrigation tools, and chemical
                fertilizers cannot be returned for safety and quality reasons.
              </p>
            </section>
            ...
            <section className="bg-green-50/30 p-8 rounded-[32px] border-2 border-green-50">
              ...
              <p className="text-gray-500 font-bold leading-relaxed">
                If you have questions about your return, contact us on WhatsApp
                or visit our store in Kargoon. We are committed to ensuring our

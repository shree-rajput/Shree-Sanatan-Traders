    ...
    <div className="min-h-screen bg-gray-50 font-sans py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <span className="bg-orange-100 text-orange-800 text-sm font-bold px-3 py-1 rounded-full">{orders.length} {orders.length === 1 ? 'Order' : 'Orders'}</span>
        </div>
        ...
        {orders.length === 0 ? (
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-16 text-center">
            ...
            <p className="text-gray-500 mb-8">You haven't placed any orders yet. It's time to change that!</p>
            <Link to="/products" className="inline-block bg-orange-600 text-white font-bold px-8 py-3 rounded-full shadow hover:bg-orange-700 transition">Browse Products</Link>
          </div>
        ) : (
            ...
            {orders.map((o) => (
              <div key={o._id} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition duration-300 border border-gray-100 overflow-hidden">
                <div className="border-b border-gray-100 bg-gray-50/50 px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">Total Fixed Price</p>
                      <p className="font-black text-orange-600 text-lg">₹{o.totalPrice || o.finalAmount || 0}</p>
                    </div>
                    {/* Status Badge */}
                ...
                <div className="px-6 py-5">
                  <h4 className="text-sm font-semibold text-gray-700 mb-4">Items Purchased</h4>
                  ...
                  {o.shippingAddress && (
                     <div className="mt-5 pt-4 border-t border-dashed border-gray-200">
                        <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">Delivered To</p>

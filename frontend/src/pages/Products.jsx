    ...
    <div className="min-h-screen bg-gray-50/50 pb-20">
      ...
      <div className="bg-white border-b border-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4 tracking-tight">Our <span className="text-green-600">Products</span></h1>
          <p className="text-gray-500 font-medium max-w-lg mx-auto">High-quality agricultural tools and equipment for modern farming.</p>
